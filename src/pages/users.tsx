    ...
    <Layout title="Pacientes" >
      ...
      <div className="flex flex-col m-20 rounded border">
        ...
        <div className="flex flex-row" >
          ...
          {/* <select onChange={setCidadeId} className="form-select p-2 m-1 w-3/12 block rounded-md border-gray-300
        shadow-sm">
            <option defaultValue={0} >Selecione a cidade</option>
            <option value={1} >Belo Horizonte</option>
            <option value={2} >São Paulo</option>
            <option value={3} >Santa Catarina</option>
            <option value={4} >Pernanbuco</option>
          </select> */}
           <InputComponent
